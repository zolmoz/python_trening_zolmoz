...
'''''def test_edit_rose_contact(app):
    success = True
    app.session.login(user_name="admin", password="secret")
    app.contactedit.edit_first_contact_rose(Contactfilld( firstname="Moon", middlename="Moon", lastname="Moon", nickename="Moon", title="Moon Ray",
                        company="Moon", address="Moon", home="1234", mobile="5678", work="90123", fax="4567",
                        email1="1admin@z.ru", email2="2admin@z.ru", email3="3admin@z.ru", homepage="ya.ry", selectbday="3",
                        selectbmonthe="4", byear="1989", selectaday="8", selectamothe="12", ayear="2000", address2="Moon", phone2="Moon", notes="Moon"))
    app.session.logout()